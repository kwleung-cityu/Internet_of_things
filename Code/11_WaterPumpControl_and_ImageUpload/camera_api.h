...
#define DEFAULT_FRAME_SIZE   FRAMESIZE_SVGA     // highest resolution is FRAMESIZE_QXGA (2048x1536)
#define DEFAULT_JPEG_QUALITY 10                 // (0,63), don't go lower than 4 due to memory constraint in ESP32-S3
