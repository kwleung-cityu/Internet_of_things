# Challenge 3: Uploading the images to Google Drive and ThingSpeak

**The source code of this demo is located at the `Code/9_Images_Upload_GoogleDrive_ThingSpeak/` folder.**
